...
'''
ohlc =  predicted_prices[['Open', 'High', 'Low', 'Close']]
...
ax.set_title('{} Share Price'.format(company), color='white')
...
#mpf.plot(ax, ohlc.values, type='renko') #savefig = 'chart-mplfinance.png'
